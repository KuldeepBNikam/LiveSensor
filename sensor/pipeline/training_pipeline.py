...
class TrainPipeline:
    ...
    def start_model_evalation(self,data_validation_artifact:DataValidationArtifact,
    ...
    def run_pipeline(self):
        try:
            ...
            model_eval_artifact = self.start_model_evalation(data_validation_artifact,model_trainer_artifact)
